...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        ...
        when {
            ...
            length.isEmpty() -> edtLength.error = "Field ini harus diisi!"
            width.isEmpty() -> edtWidth.error = "Field ini harus diisi!"
            height.isEmpty() -> edtHeight.error = "Field ini harus diisi!"
